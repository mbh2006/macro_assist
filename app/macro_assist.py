...
def get_paths() -> Dict[str, str]:
    return {
        ...
        "equation_index_path": DEFAULT_EQUATION_INDEX_PATH,
...
def generate_response_from_context(
    ...
    try:
        ...
        fallback_answer = (
            ...
            "You can change the LLM to get the desired results."
            "Generation provider -> change provider"
            "Generation model -> change model"
            "Below is the most relevant textbook content retrieved:\n\n"
